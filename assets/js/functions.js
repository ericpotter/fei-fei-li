...
function setLanguage(lang) {
	...
	document.getElementById('timeline-content-fifteen').innerHTML = translations[lang].timelineContentFifteen; document.getElementById('timeline-content-sixteen').innerHTML = translations[lang].timelineContentSixteen;
}
